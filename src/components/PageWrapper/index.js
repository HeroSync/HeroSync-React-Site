            ...
            <header className={props.headerClassName}>
                <Navbar bg="dark" variant="dark" expand="lg" fixed="top" >
                    ...
                    <Navbar.Collapse id="header-nav" className="justify-content-end">
                        <Nav fill className="mr-auto" variant="pills">
                            <Nav.Item>
                                <Nav.Link href="https://demo.herosync.com" target="_blank">
                                    Play the Alpha!
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                            ...
                            <Nav.Item>
                                <Nav.Link href="https://docs.google.com/document/d/1getWCdeTM1ulyT-rdWILcKum0K9Pnjqj1e6QLXmbmFA/edit#" target="_blank">
                                    Rulebook
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
